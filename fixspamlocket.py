"""
Locket Friend Spam Tool - Python 3 (Đã sửa lỗi 404, dùng endpoint getUserByUsername)
"""
...
# ============================================
# CẤU HÌNH - ĐÃ CẬP NHẬT ENDPOINT MỚI
# ============================================
BASE_URL = "https://api.locketcamera.com"
SEARCH_ENDPOINT = "/getUserByUsername"      # Endpoint tìm kiếm theo username (đã sửa)
...
class LocketSpamTool:
    ...
    # ============================================
    # HÀM LẤY TOKEN - DÁN TOKEN CỦA BẠN VÀO ĐÂY
    # ============================================
    def get_auth_token(self):
        # THAY token này bằng token thật của bạn
    ...
    # ============================================
    # HÀM TÌM KIẾM USERNAME - ĐÃ SỬA DÙNG getUserByUsername
    # ============================================
    def search_username(self, username_or_link):
        ...
        # ==== SỬA: DÙNG ENDPOINT /getUserByUsername VỚI THAM SỐ username ====
        search_url = f"{BASE_URL}{SEARCH_ENDPOINT}"
        
        headers = self.session.headers.copy()
        headers["Authorization"] = f"Bearer {self.get_auth_token()}"
        
        # Tham số gửi dạng query string (GET) vì endpoint có tên "getUserByUsername"
        params = {
            "username": username_or_link
        }
        
        try:
            # Dùng GET vì đây là endpoint lấy thông tin
            response = self.session.get(search_url, params=params, headers=headers, timeout=15)
            
            # Nếu GET bị lỗi, thử POST (fallback)
    ...
    def run(self):
        print("=" * 50)
        print("  LOCKET FRIEND SPAM TOOL v3.0")
        print("  (Đã sửa: dùng getUserByUsername + GET)")
        print("=" * 50)
